...
static u32 __AXMixCycles[32] = {
    ...
    0x00000B7C, 0x00001432, 0x00000B7C, 0x00000B7C, 0x00000B7C, 0x00000B7C,
    0x0000134C, 0x000021E3, 0x0000134C, 0x000021E3, 0x0000134C, 0x000021E3,
    0x0000134C, 0x000021E3
};
...
void __AXSyncPBs(u32 lessDspCycles)
{
    ...
    for (pvpb = __AXGetStackHead(0); pvpb; pvpb = pvpb->next) {
        ...
        __AXPB[pvpb->index].state = __AXPB[pvpb->index].update.updNum[0] =
            __AXPB[pvpb->index].update.updNum[1] =
                __AXPB[pvpb->index].update.updNum[2] =
                    __AXPB[pvpb->index].update.updNum[3] =
