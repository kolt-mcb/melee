...
void ftPe_Init_OnLoad(HSD_GObj* gobj)
{
    ...
    PC_ATTR_STORE(extAtrrs->floatfallf_anim_start,
                  lbAnim_8001E8F8(ftData_80085E50(fp, 18)));
    PC_ATTR_STORE(extAtrrs->floatfallb_anim_start,
                  lbAnim_8001E8F8(ftData_80085E50(fp, 19)));
