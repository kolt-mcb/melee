...
#if BUILD_TARGET_PC
    /* PC port: the console's .data runs gmResultPlayerColors straight into the
     * rest of this 0xF08-byte block; here the cast reads past the end of a
     * four-word array. Use the whole object, loaded from boot.dol by
