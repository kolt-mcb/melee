...
/* xC4 was a { ptr, arr[6] } union here while the symbol array was read by
 * walking past it; upstream gave that array a home of its own
 * (Map_GroundVars::symbol), so this view holds a single object again. */
