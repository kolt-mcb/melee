...
typedef struct grHr_StageDataLocal {
...
void grHomeRun_8021C754(void)
{
    ...
    grHr_804D6AE8[0] = Ground_801C49F8();
...
void grHomeRun_8021D680(Ground_GObj* gobj)
{
    ...
    if (gobj2 != NULL) {
        ...
        } else if (gp2->gv.homerun2.xC4 > x0) {
            gobj2 = grHomeRun_8021E500(gp2->gv.homerun2.xC4 - 1);
            for (i = 63; i > 0; i--) {
                ((grHomeRun_MainGroundVars*) &gp->gv.homerun)->gobjs[i] =
                    ((grHomeRun_MainGroundVars*) &gp->gv.homerun)
                        ->gobjs[i - 1];
...
void grHomeRun_8021DF50(Ground_GObj* gobj)
{
    ...
    if ((u32) gp->gv.unk.xCC != 0) {
        if ((u32) gp->gv.unk.xC8 == 0) {
            ...
            gp->gv.unk.xC8 = (int) grHomeRun_8021EC58(gp->gv.homerun2.xC6);
...
void fn_8021EB10(HSD_GObj* target_cam_gobj, int pc_render_code)
{
    (void) pc_render_code;
