...
#if BUILD_TARGET_PC
    /* The accessor yields NULL until this stage's block is converted -- see
     * ground.c. Everything after this reads through the pointer. */
...
void grShrineRoute_80208F70(Ground_GObj* gobj)
{
            ...
            if (!(gp->u.shrineroute.xC6 & (1 << ix))) {
                ...
                HSD_ASSERT(0x213, gp->u.map.symbol[ix]);
                {
                    ...
                    if (mid == 3) {
                        ...
                        grMaterial_801C9604(
                            (HSD_GObj*) gobj,
                            GR_COLOR_SCRIPT(yakumono_param->x0), 0);
                        temp = Ground_GetMapGObj(2);
                        if (temp != NULL) {
                            grMaterial_801C9604(
                                temp, GR_COLOR_SCRIPT(yakumono_param->x0), 0);
                        }
                        if (result != 0xBD) {
                            HSD_JObj* j =
        ...
        if (grLib_801C96E8((HSD_GObj*) gobj) != 0) {
            ...
            if (gp->u.shrineroute.xD4 != 0) {
                grMaterial_801C9604((HSD_GObj*) gp->u.shrineroute.xD4,
                                    GR_COLOR_SCRIPT(yakumono_param->x4), 0);
            }
        }
        break;
    }
    ...
    case 3: {
            ...
            (gp->u.shrineroute.xCC != 0))
        {
            ...
            if (gp->u.shrineroute.xD4 != 0) {
                grMaterial_801C9604((HSD_GObj*) gp->u.shrineroute.xD4,
                                    GR_COLOR_SCRIPT(yakumono_param->x8), 0);
            }
            stage_info.x6DC = 0;
    ...
    case 4: {
            ...
            (gp->u.shrineroute.xD4 == 0))
        {
            ...
            grMaterial_801C9604((HSD_GObj*) gobj,
                                GR_COLOR_SCRIPT(yakumono_param->xC), 0);
            {
                HSD_GObj* gr2 = Ground_GetMapGObj(2);
                if (gr2 != NULL) {
                    grMaterial_801C9604(
                        gr2, GR_COLOR_SCRIPT(yakumono_param->xC), 0);
                }
            }
        }
        break;
...
void grShrineRoute_80209BEC(Ground_GObj* gobj)
{
    ...
    if (rot > 0.2617994f) {
        ...
        gp->u.shrineroute3.xC8 = -ABS(gp->u.shrineroute3.xC8);
        {
            f32 tmp = HSD_Randf();
            gp->u.shrineroute3.xD0 =
                SR_FMA(0.00006981317f, -tmp, -0.000017453292f);
        }
