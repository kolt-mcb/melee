...
#if BUILD_TARGET_PC
/* the form-group table; the decomp labels its address psNumCmdList, which
 * particle.h declares as the int count array -- on the host the two are
 * separate objects, so the cast at the use site has to land on this one. */
