...
/* PC builds define this as `static inline` (port/pc_prelude.h); the
 * GameCube build keeps the plain `inline` the matching depends on. */
#ifndef PC_STATIC_INLINE
#define PC_STATIC_INLINE inline
#endif
